...
const PriceCard: React.FC<PriceCardProps> = ({ 
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-6 flex flex-col shadow-sm hover:shadow-xl transition-all duration-300 relative overflow-hidden group h-full">
      ...
      <div className="absolute top-0 right-0 bg-slate-50 text-[8px] font-black px-3 py-1.5 rounded-bl-2xl text-slate-300 uppercase tracking-widest group-hover:bg-primary/5 transition-colors">
        {record?.arrival_date}
      </div>
    </div>
  );
